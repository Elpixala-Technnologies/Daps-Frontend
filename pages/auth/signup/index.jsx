            ...
            <div className="shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-6  w-full p-4">
              <div className="xxs:px-[25px] xs:px-[30px] sm:px-[30px] md:px-[30px] lg:px-[28px] xl:px-[40px] py-10  bg-[#f7f7f7] shadow-md rounded-lg">
                ...
                <div className="social-login md:w-[50%] flex mx-auto">
                  <div
                    className="flex px-4 items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer"
                  ...
                  >
                    ...
                    <h1 className="px-2 py-3 font-bold text-[1.5rem]">
                      Sign in with Google
                    </h1>
                  </div>
