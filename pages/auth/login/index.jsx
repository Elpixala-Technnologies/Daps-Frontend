...
import {AuthIcons } from "@/src/Assets";
      ...
      <div className="my-6 container">
        <div className="w-full bg-white md:py-20 md:px-16  flex justify-center items-center md:flex-row flex-col gap-6">
          <div className="items-center justify-center  lg:flex hidden md:block">
            <Image className="" src={AuthIcons} alt="userLogin"
          ...
          <div className="shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-6 md:w-[80%]">
            <div className="my-3 ">
              ...
              <div className="social-login">
                <div
                  className="flex items-center  mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer"
                ...
                >
                  ...
                  <span className="w-5/6 px-2 text-[1.5rem] py-3 font-bold ">
                    Sign in with Google
                  </span>
                </div>
