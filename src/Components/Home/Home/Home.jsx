    ...
    return (
        <section >
               <div className={`${showModal ? 'd-none' : 'bg-[#0000005e] md:relative fixed md:d-none d-block top-0 left-0 right-0 bottom-0 w-full md:p-0 p-2 z-[200]'} `}>
                     <div className={`${showModal ? 'h-[0px]' : 'h-[60vh] pb-12 md:h-[0px] md:p-0 p-4'} overflow-hidden duration-300 modal md:d-none block  bottom-0 left-0 w-full rounded-t-3xl  fixed z-[1000] bg-white   text-black`}>
                            ...
                            <div className="modal-content justify-center flex flex-col align-center text-black pt-6 text-center">
                                <p className="text-xl font-[300] text-center">BoAt,</p>
