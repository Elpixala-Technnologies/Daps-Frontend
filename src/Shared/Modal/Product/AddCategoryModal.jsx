...
//     // ======
//     const iconUploadData = new FormData();
//     iconUploadData.append("file", iconImage);
//     iconUploadData.append(
//       "public_id",
//       `${cloud_folder}/${iconImage?.name}`
//     );
//     iconUploadData.append("upload_preset", `${upload_preset}`);
//     iconUploadData.append("cloud_name", `${cloud_name}`);
//     const iconRes = await fetch(`${cloud_api}`, {
//       method: "POST",
//       body: iconUploadData,
//     });
//     const icondata = await iconRes.json();
//     const iconurl = icondata?.secure_url;
  ...
  const uploadImage = async (file) => {
    ...
    try {
      ...
      if (imgRes.ok) {
        ...
        throw new Error(`Image upload failed: ${imgRes.status} ${imgRes.statusText}`);
      }
    } catch (error) {
      throw error;
    }
