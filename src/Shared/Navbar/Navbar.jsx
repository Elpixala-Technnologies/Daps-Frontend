...
const Navbar = () => {
  ...
  return (
    <header
      className="shadow bg-[#F6F6F6]  sticky top-0 z-50 mx-auto"
      style={{
        zIndex: "9999",
      }}
    >
          ...
          <div className="manu-items md:flex gap-4 justify-center items-center hidden ">
            <ul className="flex gap-8 justify-center items-center ">
              <li>
                ...
                >
                  <h1 className="relative cursor-pointer flex gap-2 text-[1.1rem] items-center  upercase">
                    <GiHamburgerMenu className="text-[1.5rem] text-[#18568C]" />
                    Shop By Cars{" "}
